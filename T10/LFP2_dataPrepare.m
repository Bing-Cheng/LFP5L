...
blockname = {'T5L-11-16-10-A','T5L-11-17-10-A','T5L-11-18-10-A','T5L-11-19-10-A','T5L-11-22-10-A','T5L-11-23-10-A','T5L-11-24-10-A',...
    ...
    'T5L-12-08-10-A','T5L-12-09-10-A','T5L-12-10-10-A','T5L-12-13-10-A','T5L-12-15-10-A'};%,'T5L-12-16-10-A'};
block_ch = [1:16];

modeFlag = 1;%0:resting; 1:cue on; 2:interval;

dir = ['E:\dataLFP\T10_wave\channel_data\sectioned\'];
odir =  'H:\preparedDataLFP\T10\';
windowLength = 6000;
fftLength = 500;
fs= 24414;
rfs = 1000;
