...
for i = 1 : ratNumber
    ...
    FqBEWc3 = mean(fftW1DmcBE(FqDis,wBE3),2); 
            ...
            FqBERa = FqBERa + (FqBERc2+FqBERr2)/2;
            FqBEWa = FqBEWa + (FqBEWc2+FqBEWr2)/2;
            FqAERa = FqAERa + (FqBERc3+FqBERr3)/2;
            FqAEWa = FqAEWa + (FqBEWc3+FqBEWr3)/2;
...
save('G:\LFP5LOutput\BE3.mat','BERc1','BERr1','BEWc1','BEWr1','BERc2','BERr2','BEWc2','BEWr2','BERc3','BERr3','BEWc3','BEWr3','BSR','BSW');
  ...
  % plot(x2(2),yy(2),x2(3),yy(3),x2(4),yy(4),x2(1),yy(1),'color',[0.9 0.8 0.8]);
       ...
       h1= plot(XX1, interp1(XX,FqBSRa/10,xi,'spline'),'g');
       h2 = plot(XX1, interp1(XX,FqBSWa/10,xi,'spline'),'--g');
       h3 = plot(XX1, interp1(XX,FqBTRa/10,xi,'spline'),'r');
       h4 =  plot(XX1, interp1(XX,FqBTWa/10,xi,'spline'),'--r');
       h5 =  plot(XX1, interp1(XX,FqACRa/10,xi,'spline'),'b');
       h6 =  plot(XX1, interp1(XX,FqACWa/10,xi,'spline'),'--b');
       h7 =  plot(XX1, interp1(XX,FqBERa/10,xi,'spline'),'m');
       h8 =  plot(XX1, interp1(XX,FqBEWa/10,xi,'spline'),'--m');
       h7 =  plot(XX1, interp1(XX,FqAERa/10,xi,'spline'),'y');
       h8 =  plot(XX1, interp1(XX,FqAEWa/10,xi,'spline'),'--y');
