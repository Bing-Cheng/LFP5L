function colorMap500S4RW1(ratName, blockname, disFreq,postFix)
rat = [ratName(1) '5L'];
...
save([odir rat 'fft' postFix], 'fftR1Dmc', 'fftW1Dmc');
 ...
 h = figure; hold on;
        ...
        avgR = mean(thetaR1c(201:400))
        avgW = mean(thetaW1c(201:400))
