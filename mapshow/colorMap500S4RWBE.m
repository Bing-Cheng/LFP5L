function colorMap500S4RWBE(ratName, blockname, disFreq)
rat = [ratName(1) '5L'];
...
fftR1DmcBE = fftR1Dc/dateNN;
fftW1DmcBE = fftW1Dc/dateNN;
fftR1DmrBE = fftR1Dr/dateNN;
fftW1DmrBE = fftW1Dr/dateNN;
if(isnan(fftR1DmcBE))
    tmp=1;
end
save([odir rat 'fftBEcr'], 'fftR1DmcBE', 'fftW1DmcBE', 'fftR1DmrBE', 'fftW1DmrBE');
