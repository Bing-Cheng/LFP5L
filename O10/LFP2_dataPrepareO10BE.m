...
datatype = 'Wave';
rat = 'O5L';
blockname = {'O5L-10-04-10-A','O5L-10-05-10-A','O5L-10-07-10-A','O5L-10-08-10-B','O5L-10-11-10-A'};
%,'O5L-10-06-10-B'
block_ch = [1:16];

modeFlag = 1;%0:resting; 1:cue on; 2:interval;

dir = ['G:\dataLFP\O10_wave\sectionedBE2s\'];
odir =  'G:\preparedDataLFP\O10\';
windowLength = 2000;
fftLength = 500;
fs= 24414;
rfs = 1000;
...
%         break;
removeTrial = [removeTrial i]
    end
end%trial
fftMatrixSumRCorrection(:,:,removeTrial) = [];
fftPhaseSumRCorrection(:,:,removeTrial) =  [];
